define(["exports"], function(t) {
    ...
    function B(t, e) {
        ...
        const s = e.replace(/FromIndex$/, "")
          , n = e !== s
          , r = E.includes(s);
        if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || !r && !N.includes(s))
            return;
    ...
    class M {
        ...
        async getDb() {
            return this.h || (this.h = await function(t, e, {blocked: s, upgrade: n, blocking: r, terminated: i}={}) {
    ...
    class P {
        ...
        async delete() {
            this.R = !1,
            await this.L.expireEntries(1 / 0)
        }
    }
    function j(t, e) {
        const s = new URL(t);
    ...
    t.RangeRequestsPlugin = class {
        constructor() {
            this.cachedResponseWillBeUsed = async ({request: t, cachedResponse: e}) => e && t.headers.has("range") ? await F(t, e) : e
        }
    }
    ,
